...
#define GIM_Calibrate_TIM    1.8    //回正时间           单位为 秒
#define GIM_CalibrateOK_TIM  0.01  //判断回正完成时间   单位为 秒
...
#define Calibrate_AngleErr  8   //判断回正完成允许的最大误差 8 
